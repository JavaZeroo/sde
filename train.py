...
def main_worker(args):
    ...
    with Progress(
        ...
        while not progress.finished:
            for iter in range(60*args.epoch_nums):
                ...
                new_dl = DataLoader(temp_ds, batch_size=args.batch_size, shuffle=True, num_workers=10)
                ...
                torch.save(model.state_dict(), args.log_dir / f'model_unet_{int(iter)}.pth')
    ...
    torch.save(model.state_dict(), args.log_dir / 'model_unet.pth')
